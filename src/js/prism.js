/* http://prismjs.com/download.html?themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+ruby+css-extras+git+handlebars+http+json+makefile+nginx+objectivec+php+python+jsx+scss+yaml */
var _self =
