...
My corporation is Latchbolt Inc. I let myself nerd out on a holding page at [latchbolt.tech](https://latchbolt.tech). Latchbolt isn’t a single product. It’s a place where I can build anything I’m inspired to. What I’m inspired to build right now is software for niche audiences. Software that’s made with care for caring people. Software that, hopefully, brings a smile to at least one person’s face. We need that right now. That does describe the side projects I build when left to my own devices. The difference is, I’ll charge money for things under the Latchbolt banner.
